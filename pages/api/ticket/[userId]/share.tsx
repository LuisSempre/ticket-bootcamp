  ...
  return (
    <main className="lg:h-screen max-w-[480px] lg:max-w-[1240px] p-12 mx-auto flex items-center gap-24 flex-col lg:flex-row">
      ...
      <div className="max-w-[420px] text-center lg:text-left">
        ...
        <strong className="block mt-4 text-4xl leading-tight text-neutral-200">
          {ogDescription}
        </strong>
        ...
        <a
          ...
          className="flex items-center justify-center w-full gap-2 px-6 py-4 mt-8 font-bold text-black rounded group bg-brand-500 hover:bg-brand-300"
        >
